...
export const currentProjects : Project[] = [
  ...
  },
  {
    ...
    details: {
      ...
      description: 'The E-Commerce Platform is a dynamic React application offering a streamlined online shopping experience. Leveraging Chakra UI, the platform delivers a sleek and accessible interface, enhancing user engagement and navigation.',
      descriptionSub: "Redux manages the application's global state, ensuring consistent user experiences and smooth data flow across components. The meticulous design covers all e-commerce functions, while React's component-based architecture promotes clean, reusable code. The application's predictability and maintenance are enhanced by Redux's state container, making this platform a paragon of efficient and user-centric eCommerce development.",
      features: [],
      technologiesUsed: [''],
      projectMedia: [''],
    },
  ...
  //   demo: 'http://example.com/project1/demo',
  //   details: {
  //     bannerImg: '../../../assets/images/projects/blog/typing_v2.jpg',
  //     subBannerImg: '../../../assets/images/projects/blog/typing.jpg',
  //     description: '',
  //     features: [],
  //     descriptionSub: '',
  //     technologiesUsed: [''],
  ...
  // },
  {
    ...
    details: {
      ...
      subBannerImg: '../../../assets/images/projects/reactEcommerce/reactIDE.jpg',
      description: '',
      features: [],
      descriptionSub: '',
      technologiesUsed: [''],
